...
export class ChatMessage {
  ...
  constructor(data?: Partial<ChatMessage>) {
    if (data) {
      Object.assign(this, data); // usa getters/setters públicos (id, type, ...)
    }
  }

  get id(): string { return this._id; }        // 👈 NUEVO
  set id(v: string) { this._id = v; }          // 👈 NUEVO
